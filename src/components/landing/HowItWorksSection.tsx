  ...
  return (
    <div className="relative mx-auto w-[280px] md:w-[300px]">
      ...
      <div className="relative bg-[#1a1a1a] rounded-[2.5rem] p-3 shadow-2xl">
        ...
        <div className="bg-background rounded-[2rem] overflow-hidden min-h-[480px] pt-10 px-4 pb-6">
          ...
          <div className="bg-card rounded-2xl p-4 shadow-sm mb-4">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <p className="font-bold text-foreground text-sm">{phonePreview.location}</p>
            ...
            <div className="flex gap-2">
              ...
              <button
                type="button"
                className="flex-1 py-2 rounded-full bg-background text-foreground text-xs font-semibold border border-border"
              >
                Maybe
              </button>
            </div>
          ...
          <div className="bg-secondary/15 rounded-xl px-3 py-2 flex items-center gap-2">
            ...
            <p className="text-foreground text-xs truncate">{phonePreview.latestMessage}</p>
          </div>
        </div>
      </div>
            ...
            return (
              <div key={step.id} className="flex gap-5 items-start">
                <div className="relative flex-shrink-0">
                  <div className="w-14 h-14 rounded-xl bg-background border border-border/50 flex items-center justify-center">
                    <span className="text-muted-foreground font-bold text-sm">{step.number}</span>
                  </div>
                  <div className="absolute -top-1 -right-1 w-6 h-6 rounded-md bg-card shadow flex items-center justify-center">
                    <Icon className="w-3.5 h-3.5 text-foreground" />
                  </div>
                </div>
                <div className="pt-1">
                  <h3 className="font-display text-foreground text-lg md:text-xl font-semibold mb-2">
                    {step.title}
                  </h3>
