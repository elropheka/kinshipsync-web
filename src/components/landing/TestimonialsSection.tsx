...
const TESTIMONIALS = [
  {
    ...
    quote:
      "Planning our annual family reunion used to be a nightmare. With Kinship Sync, I can easily coordinate with 50+ family members, track RSVPs, and share updates. It's been a game-changer for our family gatherings!",
    location: 'Atlanta, GA',
  },
  {
    img: testimonial2,
    ...
    quote:
      "The collaborative features made planning my sister's wedding so much easier. We could all contribute ideas, track the guest list, and manage the schedule in one place. It brought our family closer during the planning process.",
    location: 'Chicago, IL',
  },
  {
    img: testimonial3,
    ...
    quote:
      'As someone who organizes multiple family events throughout the year, Kinship Sync has been invaluable. The RSVP management and scheduling features save me hours of work, and the mobile app makes it easy to update on the go.',
    location: 'Miami, FL',
  },
  {
    img: testimonial4,
    ...
    quote:
      "I love how Kinship Sync understands the importance of family traditions while making event planning modern and efficient. The gift registry feature was especially helpful for our family's milestone celebrations.",
    location: 'Houston, TX',
  },
] as const;
