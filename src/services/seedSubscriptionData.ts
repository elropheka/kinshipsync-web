...
const defaultPlans = [
  {
    ...
    interval: 'month',
    trialDays: 0,
    features: ['Create up to 1 event', 'Basic event page', 'RSVP tracking', 'Email notifications'],
    isActive: true,
    sortOrder: 0,
  ...
  },
  {
    ...
    interval: 'month',
    trialDays: 14,
    features: ['Everything in Basic', 'Unlimited events', 'Priority support', 'Advanced analytics', 'Custom themes', 'Team collaboration', 'Export & reporting'],
    isActive: true,
    sortOrder: 2,
