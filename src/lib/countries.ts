export interface Country {
  ...
  // flag?: string; // Optional: for SVG string or path to flag image if available
}

// A subset of countries with calling codes for demonstration.
...
export const countries: Country[] = [
  ...
  // --- Add more countries below as needed, or use a comprehensive list from a library/source ---
  ...
  // Antarctica does not have a country calling code.
  // { code: "AQ", name: "Antarctica", callingCode: "" }, 
  ...
  // Bouvet Island does not have a country calling code.
  // { code: "BV", name: "Bouvet Island", callingCode: "" },
  ...
  { code: "DO", name: "Dominican Republic", callingCode: "+1-809" }, // +1-829, +1-849
  ...
  // French Southern Territories does not have a country calling code.
  // { code: "TF", name: "French Southern Territories", callingCode: "" },
  ...
  // Heard Island and McDonald Islands does not have a country calling code.
  // { code: "HM", name: "Heard Island and McDonald Islands", callingCode: "" },
  { code: "VA", name: "Holy See", callingCode: "+379" }, // or +39 (shared with Italy)
  ...
  { code: "KZ", name: "Kazakhstan", callingCode: "+7" }, // +7-6xx, +7-7xx
  ...
  { code: "PN", name: "Pitcairn", callingCode: "+870" }, // Pitcairn uses +870 (Inmarsat)
  { code: "PL", name: "Poland", callingCode: "+48" },
  { code: "PT", name: "Portugal", callingCode: "+351" },
  { code: "PR", name: "Puerto Rico", callingCode: "+1-787" }, // +1-939
  ...
  { code: "SH", name: "Saint Helena, Ascension and Tristan da Cunha", callingCode: "+290" }, // St Helena +290, Ascension +247
  ...
  { code: "SX", name: "Sint Maarten (Dutch part)", callingCode: "+1-721" },
  ...
  { code: "GS", name: "South Georgia and the South Sandwich Islands", callingCode: "+500" }, // SGSSI uses +500 (same as Falklands)
  ...
  { code: "SJ", name: "Svalbard and Jan Mayen", callingCode: "+47" }, // Svalbard uses +47 (Norway)
  ...
  { code: "UM", name: "United States Minor Outlying Islands", callingCode: "+1" }, // No specific code, part of US NANP
  ...
  { code: "EH", name: "Western Sahara", callingCode: "+212" }, // Disputed, often uses Morocco's code
  { code: "YE", name: "Yemen", callingCode: "+967" },
  { code: "ZM", name: "Zambia", callingCode: "+260" },
  { code: "ZW", name: "Zimbabwe", callingCode: "+263" },
];
// Note: This list is not exhaustive and calling codes can be complex (e.g. shared codes, regional codes).
// For a production app, a dedicated library for phone number handling is recommended.
// Flags are not included here due to complexity of managing image assets.
